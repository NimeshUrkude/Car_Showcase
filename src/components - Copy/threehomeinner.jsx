...
function ThreeHomeinner() {
  ...
  return(
    <>
      ...
      <Ground/>
      <spotLight  rotation={[angleToRadians(-30),0,0]} color={[1, 0.25, 0.7]} intensity={2} angle={0.6} position={[5,5,0]} castShadow shadow-bias={-0.0001} penumbra={0.5}/>
      <spotLight color={[0.14, 0.5, 1]} intensity={3} angle={0.6} position={[-5,5,0]} castShadow shadow-bias={-0.0001} penumbra={0.5}/>
